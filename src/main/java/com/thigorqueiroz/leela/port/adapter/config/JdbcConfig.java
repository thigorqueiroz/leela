package com.thigorqueiroz.leela.port.adapter.config;

import com.thigorqueiroz.leela.LeelaApplication;
...
@Configuration
@EnableJdbcRepositories(basePackageClasses = LeelaApplication.class)
